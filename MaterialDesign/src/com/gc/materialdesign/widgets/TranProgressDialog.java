 ...
 *
 */
public class TranProgressDialog extends android.app.Dialog {
	...
	public TranProgressDialog(Context context, String title) {
		super(context, android.R.style.Theme_Translucent);
		this.title = title;
		this.context = context;
	}

	public TranProgressDialog(Context context, String title, int progressColor) {
		super(context, android.R.style.Theme_Translucent);
		this.title = title;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.trans_progress_dialog);
